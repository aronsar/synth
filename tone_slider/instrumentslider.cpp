...
void InstrumentSlider::volume_dial_value_changed(int new_val)
{
...
void InstrumentSlider::bpm_line_edit_text_edited(QString new_text)
{
    bpm_line_edit_string = new_text;
}

void InstrumentSlider::bpm_line_edit_editing_finished()
{
